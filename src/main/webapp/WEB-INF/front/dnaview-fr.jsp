...
<div style="width: 100%;">
    <div style="width: 100%;height:567px; margin: auto;position: relative">
        ...
        <div style="position: absolute;margin-left: 58%;margin-top: 25%;font-family: Arial;color: #0968aa;font-size: 18px">
            <div style="font-size: 24px">Quel âge avez-vous? </div>
            <div style="color: #828181;font-size: 14px">Pourquoi votre </div>
            <div style="font-size: 24px"> "âge épigénétique"</div>
            <div style="font-size: 24px">est-il important?</div>
        </div>
    </div>
            ...
            <div style="background-color: #f3f6fa;width: 100%;height: 389px;border-radius: 10px">
                ...
                <div style="width: 90%;margin: 0 auto;padding-top: 5%">
                    <div style="width: 100%;height:45px">
                        ...
                        <div style="width: 91%;float: left;line-height: 45px;font-size: 26px;">Votre âge biologique a ${data.biological} ans</div>
                    </div>
        ...
        <div style="width: 90%;margin: 0 auto;">
            <div style="width: 100%;clear: both;height: 123px">
                <div style="width: 35%;float: left"><img src="static/images/ques/rep4.png"
                                                         style="width: 100%;height: 100%"></div>
                <div style="width: 60%;margin-left: 5%;font-size: 18px; float: left">
                    Que puis-je faire si mon<span
                        style="font-size: 24px;color: #1b6fae;">«âge épigénétique» est plus vieux ?</span>
                    <div style="height: 23px;width: 100%"></div>
