            ...
            <div style="background-color: #f3f6fa;width: 100%;height: 389px;border-radius: 10px">
                ...
                <div style="width: 90%;margin: 0 auto;padding-top: 5%">
                    <div id="smail"  style="width: 100%;height:45px">
                        ...
                        <div style="width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d">Su reloj muestra que la edad genética es <Span class="Pobre"></Span>  años menor que la de la población.</div>
                    </div>
    ...
    <script>
        $(function () {
            ...
            var real1="<div id=\"smail\" style=\"width: 100%;height:45px\" >\n" +
                ...
                "                        <img src=\"static/images/ques/smail.png\"style=\"width: 100%;height: 100%\">\n" +
                "                    </div>\n" +
                "                    <div style=\"width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d\">Su reloj muestra que la edad genética es   <Span class=\"Pobre\"></Span>\n" +
                "                      años menor que la de la población.</div>\n" +
                "                </div>"
            var real2="<div id=\"smail\" style=\"width: 100%;height:45px\" >\n" +
                "                    <div style=\"width: 8%;margin-right: 2%; float: left\">\n" +
                "                        <img src=\"static/images/ques/sad.png\"style=\"width: 100%;height: 100%\">\n" +
                "                    </div>\n" +
                "                    <div style=\"width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d\">Tu reloj tiene  <Span class=\"Pobre\"></Span>\n" +
                "                        años más de edad que la población.</div>\n" +
                "                </div>"
            ...
            var test1="<div id=\"smail\" style=\"width: 100%;height:45px\" >\n" +
                ...
                "                    </div>\n" +
                "                    <div style=\"width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d\">Su reloj muestra que la edad genética es <Span class=\"Pobre\"></Span>\n" +
                "                        años menor que la prevista.</div>\n" +
                "                </div>"
            var test2="<div id=\"smail\" style=\"width: 100%;height:45px\" >\n" +
                "                    <div style=\"width: 8%;margin-right: 2%; float: left\">\n" +
                "                        <img src=\"static/images/ques/sad.png\"style=\"width: 100%;height: 100%\">\n" +
                "                    </div>\n" +
                "                    <div style=\"width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d\">Su reloj tiene <Span class=\"Pobre\"></Span>\n" +
                "                        años más de edad que la población prevista.</div>\n" +
                "                </div>"
