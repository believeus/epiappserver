...
<div style="width: 100%;">
                ...
                <div style="width: 90%;margin: 0 auto;padding-top: 5%">
                    <div id="smail"  style="width: 100%;height:45px">
                        ...
                        <div style="width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d">
                            Sua epigenética é <Span class="Pobre"></Span>Anos menor do que a idade cronológica Na população.</div>
                    </div>
    ...
    <div style="width: 100%;margin: 0px auto;">
        <div id="top-pic" style="width: 100%;height:320px;margin: 0px auto;position: relative">
            <div style="position: absolute;">
    ...
    <script>
        $(function () {
            ...
            var real1="<div id=\"smail\" style=\"width: 100%;height:45px\" >\n" +
                ...
                "                        <img src=\"static/images/ques/smail.png\"style=\"width: 100%;height: 100%\">\n" +
                "                    </div>\n" +
                "                    <div style=\"width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d\"> Sua epigenética é  <Span class=\"Pobre\"></Span>\n" +
                "                      Anos menor do que a idade cronológica Na população.</div>\n" +
                "                </div>"
            var real2="<div id=\"smail\" style=\"width: 100%;height:45px\" >\n" +
                ...
                "                    </div>\n" +
                "                    <div style=\"width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d\">Sua epigenética é <Span class=\"Pobre\"></Span>\n" +
                "                       Anos Mais Alta do que a idade cronológica Da população.</div>\n" +
                "                </div>"
            ...
            var test1="<div id=\"smail\" style=\"width: 100%;height:45px\" >\n" +
                ...
                "                    </div>\n" +
                "                    <div style=\"width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d\">Sua epigenética é  <Span class=\"Pobre\"></Span>\n" +
                "                      Anos menor do que a idade cronológica esperada Na população.</div>\n" +
                "                </div>"
            var test2="<div id=\"smail\" style=\"width: 100%;height:45px\" >\n" +
                ...
                "                    </div>\n" +
                "                    <div style=\"width: 89%;float: left;margin-left: 1%;text-align: center;line-height: 20px;font-size: 16px;font-weight: bold;color: #439e9d\">Sua epigenética é  <Span class=\"Pobre\"></Span>\n" +
                "                       Anos Mais Alta do que a idade cronológica esperada Na população.</div>\n" +
                "                </div>"
