                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="admin/logout.jhtml">退出</a></li>
                        </ul>
                    </li>
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="admin/age/view.jhtml?idx=0&size=100" data-title="Age Manager"
                           href="javascript:void(0)">Age Manager</a></li>
                    <li><a data-href="admin/list.jhtml" data-title="Age Manager" href="javascript:void(0)">Admin
                        Manager</a></li>
                </ul>
            </dd>
        </dl>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="admin/user/view.jhtml?idx=0&size=100"></iframe>
        </div>
    </div>
</section>
