            ...
            if (!isrun) {
                ...
                new Thread(new Runnable() {
                    ...
                    AwsBasicCredentials awsCreds = AwsBasicCredentials.create(
                            "AKIAVRRL6IAGN4HVZ5HZ",
                            "HBtJhQwulEFkUYqRDu3PBSi1qaRA7pmwy0P6Yov0");

                    SqsClient client = SqsClient.builder().credentialsProvider(StaticCredentialsProvider.create(awsCreds)).region(Region.US_EAST_1).build();
